...
MACRO_LINKS: tuple[MacroLink, ...] = (
    ...
    _L("rates.mortgage_30y", themes=("retail", "restaurants"), scope="platform", good_when="falling",
    ...
    _L("growth.retail_sales", themes=("retail", "restaurants", "internet"), scope="platform", good_when="rising",
    ...
    # ── credit 信用条件 ───────────────────────────────────────────────────
    _L("credit.hy_oas",
       themes=("ai_chip", "ai_optical"), scope="platform", good_when="falling", bridge_min_gap_days=28,
    ...
    # ── fx_commodity 汇率商品 ─────────────────────────────────────────────
    _L("fx.usd_broad", themes=("ai_chip",), scope="platform", good_when="falling", bridge_min_gap_days=28,
    ...
    _L("cmdty.copper", themes=("ai_chip", "ai_optical"), scope="platform", good_when="rising",
       rationale_zh="铜价=全球实体需求温度计,兼电网/数据中心建设原料——能源墙 capex 的原料端印证。"),
    # ── sentiment 情绪 ────────────────────────────────────────────────────
    _L("sentiment.umich", themes=("retail", "restaurants"), scope="platform", good_when="rising",
...
TRANSMISSIONS: tuple[MacroTransmission, ...] = (
    ...
    _T("fiscal.federal_deficit", "fiscal.public_debt", "-", "months",
       "流量赤字累积为存量债务——注意 FRED MTSDS133FMS 是盈余为正/赤字为负口径:"
       "序列值下行(赤字扩大)对应债务加速上行,值层面反向。"),
