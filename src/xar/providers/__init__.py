...
from . import (aifinmarket, arxiv, finnhub, fmp, gangtise, journals, polygon, polymarket,
...
_MARKET = [fmp, finnhub, polygon, yahoo, wind, aifinmarket, gangtise]
...
def status() -> dict[str, bool]:
    ...
    return {
        ...
        "journals": journals.available(), "gangtise": gangtise.available(),
    }
